 ...
 * @since Bent Metal Blog Theme 1.0.0
 */
...
if ( function_exists( 'add_image_size' ) ) {
  ...
  add_image_size('rect-medium', 600, 400, true);
	...
	add_image_size('square-mervin', 400, 400, true);
}
...
function my_css_attributes_filter($var) {
	return is_array($var) ? array_intersect($var, array('menu-item', 'current-menu-item', 'bindings', 'accessories', 'apparel', 'team', 'blog', 'mervin-made', 'events', 'about', 'locator')) : '';
}
...
function bm_gallery_shortcode($attr) {
    $post = get_post();
    static $instance = 0;
    $instance++;
    if ( ! empty( $attr['ids'] ) ) {
...
add_shortcode('gallery', 'bm_gallery_shortcode');
